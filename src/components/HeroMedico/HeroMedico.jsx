...
import './HeroMedico.css'
import HeaderMedico from '../HeaderMedico/HeaderMedico'
  ...
  return (
    <div className="hero">
        ...
        <div className="right-h">
            <button className='btn' onClick={() => navigate('/profile_arnold')}>Perfil</button>
            ...
            <img src={Hombre2} alt="" className='hero-image_medico' />
            <motion.img 
            initial={{right:'5rem'}}
