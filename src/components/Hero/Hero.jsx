    ...
    <div className="hero">
        ...
        <div className="left-h">
            ...
            <div className="hero-buttons">
                <button className="btn" onClick={() => navigate('/register')}>REGISTRATE</button>
                <button className="btn" onClick={() => navigate('/login')}>INICIAR SESION</button>
            </div>
        </div>
        <div className="right-h">
            ...
            <img src={Hombre2} alt="" className='hero-image' />
            <motion.img 
            initial={{right:'5rem'}}
